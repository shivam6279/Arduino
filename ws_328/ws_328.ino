...
#define wind_led A3
#define upload_led A2
#define rain_pin1 3
#define rain_pin2 4
#define wind_pin1 6
#define wind_pin2 9
#define GSM_module_DTR_pin 5
#define solar_radiation_pin A6
...
void setup(){
  ...
  if(led_mode == 0) Serial.println("Led mode: rain guage"); else if(led_mode == 1) Serial.println("Led mode: anemometer");
...
ISR(TIMER2_COMPA_vect){ 
  rain_temp = digitalRead(rain_pin1);
  ...
  wind_temp = digitalRead(wind_pin1);
