...
bool WriteSD(weatherData w) {
  ...
  datalog.print(',');
  datalog.print(w.temp1_min);
  datalog.print(',');
  datalog.print(w.temp1_max);
  datalog.print(',');
  datalog.print(w.temp2);
  datalog.print(',');
  datalog.print(w.temp2_min);
  datalog.print(',');
  datalog.print(w.temp2_max);
  datalog.print(',');
  datalog.print(w.hum);
  datalog.print(',');
  datalog.print(w.hum_min);
  datalog.print(',');
  datalog.print(w.hum_max);
  datalog.print(',');
  datalog.print(w.wind_speed);
  datalog.print(',');
  datalog.print(w.wind_max);
  datalog.print(',');
